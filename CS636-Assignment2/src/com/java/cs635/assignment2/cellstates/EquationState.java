	...
	public void setValue(CellStateContext context)
		{
			/*
			 * * @see
			 * com.java.cs635.assignment2.cellstates.EquationState#setValue(com.java.cs635.
			 * assignment2.cellstates.CellStateContext) Points to Remember: We go with the
			 * assumption that cell is not dependent on any other cell We unsubscribe it
